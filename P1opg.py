...
"""
@author: Isabel Kirkegaard - Open Data Science
"""

#Titanic.csv datasæt - Portfolio 1

#Opgave 1: Indholdet af datasættet
#a) Filen har forskellige datatyper som alder, køn og familienotater om passagerne. 
#Denne data blev først åbnet in text editor, for at se hvad datasættet indeholdt af datatyper. 
#Datasættet indeholder navne på passagerne, hvilken klasse de rejste med, om de overlevede, deres køn og alder. 
#Dernæst indeholdt datasættet også prisen på deres billet, og om hvorvidt de havde søskende, partnere eller forældre ombord. 

#b) Af data der mangler, så er der informationer der ikke vides noget om. 
#F.eks. er der et par personer, hvor der ikke vides om de havde familie ombord, eller hvad deres billet kostede. 
...
#Dette viser den deskriptive statistisk, altså hvad kan vi hive ud, der beskriver medianen, gennemsnittet osv.
print(data.describe())
...
#Str.split returnerer en liste af seperate ord i en string. Expand = true separerer string ind i kolonner, her 'Name'
