...
@author: pfg224 isabel
"""

#1. The collection
#I have chosen to use the Guardian OpenAPI. Furthermore I wanted results from the first of january this year to late october.

#First I follow the tutorial of the Guardian API key and exploring page, which I need to import to python
...
#Makes the sections into a list to use it for the rest of the tasks. A set also stops duplicates, so it will give a more clear result
...
data_vect = model_vect.fit_transform(sections)
data_vect
#Stop words are regular used words like 'a' and 'in'. These, and other similar have been removed 
#22924x98 sparse matrix


#Finding info about data like uniqueness of a section, or the total number of characters
...
terms =['video', 'youtuber', 'camera','charity']
terms 
...
#I'm having trouble to use my query (my terms) to use with the whole dataset, and compare



#this should show counts of words from my query
...
#Using wordcloud to vizualize the most commonly used terms
